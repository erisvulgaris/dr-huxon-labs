  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="relative z-10 flex max-h-[88dvh] w-full max-w-[460px] flex-col overflow-hidden rounded-t-[28px] border-t border-[oklch(0.96_0.012_80_/_0.1)] bg-background"
      >
